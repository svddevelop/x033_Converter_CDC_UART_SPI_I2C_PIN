...
// §¡§Õ§â§Ö§ã§Ñ User Data §à§Ò§Ý§Ñ§ã§ä§Ú (§Ù§Ñ§Ó§Ú§ã§Ú§ä §à§ä §Ü§à§ß§Ü§â§Ö§ä§ß§à§Û §Þ§à§Õ§Ö§Ý§Ú)
//#define USER_DATA_START_ADDR  0x1FFFF800  // §¯§Ñ§é§Ñ§Ý§î§ß§í§Û §Ñ§Õ§â§Ö§ã User Data
#define USER_DATA_START_ADDR  OB_BASE
//#define USER_DATA_END_ADDR    0x1FFFFBFF  // §¬§à§ß§Ö§é§ß§í§Û §Ñ§Õ§â§Ö§ã User Data
#define USER_DATA_END_ADDR    (USER_DATA_START_ADDR + 0x3FF)
#define USER_DATA_SIZE        (USER_DATA_END_ADDR - USER_DATA_START_ADDR + 1)
