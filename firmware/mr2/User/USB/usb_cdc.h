...
void CDC_writeBuffer(const char *buffer, uint16_t size);              // Write buffer to OUT buffer
void CDC_writeBufferOptimized(const char *buffer, uint16_t size);

void CDC_writeString(const char *str);                                // Write string (null-terminated)
void CDC_writeLine(const char *str);                                  // Write line with CRLF
void CDC_writeHex(uint32_t value, uint8_t digits);                    // Write hexadecimal number
void CDC_writeDec(int32_t value);                                     // Write decimal number
...
*/
//void CDC_printf(void (*putchar) (char c), const char *format, ...);
